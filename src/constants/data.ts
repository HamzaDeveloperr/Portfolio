import { WHATSAPP_NUMBER, BRAND_NAME } from "../utils/whatsapp";
...
export const SMM_SERVICES = {
  ...
  management: [
    ...
    "Page/profile setup & optimization",
  ...
  plans: [
    { title: "Weekly Management", description: "Full handling for 7 days." },
    { title: "Monthly Management", description: "Full handling for 30 days." },
    { title: "Custom Business Plan", description: "Tailored to your specific needs." }
  ],
  engagement: [
    "Comments handling",
